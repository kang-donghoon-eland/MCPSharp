...
var chatHistory = new List<ChatMessage>() { new(ChatRole.System, conf.Models["lmstudio"].SystemPrompt) };
var chatClient = new LmStudioChatClient(conf.Models["lmstudio"].Endpoint, conf.Models["lmstudio"].ModelId).AsBuilder().UseFunctionInvocation().Build();
